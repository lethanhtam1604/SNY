...
class CoreDataHelper {
    ...
    static var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = Bundle(for: CoreDataHelper.self).url(forResource: dbName, withExtension: "momd")! // type your database name here..
    ...
    static var persistentStoreCoordinator: NSPersistentStoreCoordinator = {
        ...
        do {
            ...
            let wrappedError = NSError(domain: Bundle.main.bundleIdentifier ?? "com.hlb", code: 9999, userInfo: dict)
